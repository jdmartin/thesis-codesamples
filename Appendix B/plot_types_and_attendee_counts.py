...
#Results contains (year, type of course, number of people in course)
results=[]
...
for file in sorted(files):
    with open("by-type" + "/" + file, 'r') as f:
        for line in f:
            ...
            if temp_a > 0:
                results.append([file, "Technical", temp_a])
            elif temp_b > 0:
                results.append([file, "Non-Technical", temp_b])
...
plt.ylabel("Number of Attendees by class type", size=14)
